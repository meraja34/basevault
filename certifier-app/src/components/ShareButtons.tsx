...
export default function ShareButtons({ url, title, text }: ShareButtonsProps) {
  ...
  const links = [
    ...
    },
    {
      ...
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          <path d="M18.24 2.4H5.76C3.936 2.4 2.4 3.936 2.4 5.76v12.48c0 1.824 1.536 3.36 3.36 3.36h12.48c1.824 0 3.36-1.536 3.36-3.36V5.76c0-1.824-1.536-3.36-3.36-3.36z"/>
        </svg>
      ),
    },
    {
  ...
  const handleCopyLink = async () => {
    try {
      ...
      // The parent component handles toast
    } catch {
